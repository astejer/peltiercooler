...
int peltier1 = 3, peltier2 = 6;     // declares the peltier pin addresses for the pwm mosfet control  
...
PID tempController(&Celsius1, &Output1, &Setpoint1, 100, 3, .75, REVERSE);     // creates a PID controller linked to the peltier1 element, description of arguements/parameters given above
